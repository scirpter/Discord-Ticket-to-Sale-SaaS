...
function init_paygatedottocryptogateway_wbtcsol_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Wbtcsol extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_wbtcsol_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/wbtc/convert.php?value=' . $paygatedottocryptogateway_wbtcsol_total . '&from=' . strtolower($paygatedottocryptogateway_wbtcsol_currency), array('timeout' => 30));
                  ...
                  if ($this->wbtcsol_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_wbtcsol_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/wbtc/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_wbtcsol_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/wbtc/convert.php?value=' . $paygatedottocryptogateway_wbtcsol_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_wbtcsol_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/wbtc/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_wbtcsol_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/wbtc/wallet.php?address=' . $this->wbtcsol_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_wbtcsol_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_wbtcsol_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_wbtcsol_wallet_decbody && isset($paygatedottocryptogateway_wbtcsol_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_wbtcsol_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/wbtc/qrcode.php?address=' . $paygatedottocryptogateway_wbtcsol_gen_addressIn, array('timeout' => 30));
