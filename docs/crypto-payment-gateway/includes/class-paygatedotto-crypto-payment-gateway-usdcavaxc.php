...
function init_paygatedottocryptogateway_usdcavaxc_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Usdcavaxc extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_usdcavaxc_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/avax-c/usdc/convert.php?value=' . $paygatedottocryptogateway_usdcavaxc_total . '&from=' . strtolower($paygatedottocryptogateway_usdcavaxc_currency), array('timeout' => 30));
                  ...
                  if ($this->usdcavaxc_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_usdcavaxc_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/avax-c/usdc/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_usdcavaxc_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/avax-c/usdc/convert.php?value=' . $paygatedottocryptogateway_usdcavaxc_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdcavaxc_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/avax-c/usdc/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdcavaxc_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/avax-c/usdc/wallet.php?address=' . $this->usdcavaxc_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_usdcavaxc_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_usdcavaxc_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_usdcavaxc_wallet_decbody && isset($paygatedottocryptogateway_usdcavaxc_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_usdcavaxc_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/avax-c/usdc/qrcode.php?address=' . $paygatedottocryptogateway_usdcavaxc_gen_addressIn, array('timeout' => 30));
