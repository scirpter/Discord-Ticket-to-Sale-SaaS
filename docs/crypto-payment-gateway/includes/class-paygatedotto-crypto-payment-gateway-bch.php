...
function init_paygatedottocryptogateway_bch_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Bch extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_bch_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/bch/convert.php?value=' . $paygatedottocryptogateway_bch_total . '&from=' . strtolower($paygatedottocryptogateway_bch_currency), array('timeout' => 30));
                  ...
                  if ($this->bch_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_bch_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/bch/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_bch_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/bch/convert.php?value=' . $paygatedottocryptogateway_bch_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_bch_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/bch/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_bch_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/bch/wallet.php?address=' . $this->bch_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_bch_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_bch_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_bch_wallet_decbody && isset($paygatedottocryptogateway_bch_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_bch_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/bch/qrcode.php?address=' . $paygatedottocryptogateway_bch_gen_addressIn, array('timeout' => 30));
