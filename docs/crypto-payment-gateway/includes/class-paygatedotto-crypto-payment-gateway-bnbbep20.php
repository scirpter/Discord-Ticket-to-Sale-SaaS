...
function init_paygatedottocryptogateway_bnbbep20_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Bnbbep20 extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_bnbbep20_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/bep20/bnb/convert.php?value=' . $paygatedottocryptogateway_bnbbep20_total . '&from=' . strtolower($paygatedottocryptogateway_bnbbep20_currency), array('timeout' => 30));
                  ...
                  if ($this->bnbbep20_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_bnbbep20_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/bep20/bnb/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_bnbbep20_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/bep20/bnb/convert.php?value=' . $paygatedottocryptogateway_bnbbep20_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_bnbbep20_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/bep20/bnb/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_bnbbep20_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/bep20/bnb/wallet.php?address=' . $this->bnbbep20_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_bnbbep20_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_bnbbep20_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_bnbbep20_wallet_decbody && isset($paygatedottocryptogateway_bnbbep20_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_bnbbep20_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/bep20/bnb/qrcode.php?address=' . $paygatedottocryptogateway_bnbbep20_gen_addressIn, array('timeout' => 30));
