...
function init_paygatedottocryptogateway_usdtpolygon_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Usdtpolygon extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_usdtpolygon_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/usdt/convert.php?value=' . $paygatedottocryptogateway_usdtpolygon_total . '&from=' . strtolower($paygatedottocryptogateway_usdtpolygon_currency), array('timeout' => 30));
                  ...
                  if ($this->usdtpolygon_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_usdtpolygon_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/usdt/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_usdtpolygon_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/usdt/convert.php?value=' . $paygatedottocryptogateway_usdtpolygon_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdtpolygon_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/usdt/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdtpolygon_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/usdt/wallet.php?address=' . $this->usdtpolygon_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_usdtpolygon_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_usdtpolygon_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_usdtpolygon_wallet_decbody && isset($paygatedottocryptogateway_usdtpolygon_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_usdtpolygon_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/usdt/qrcode.php?address=' . $paygatedottocryptogateway_usdtpolygon_gen_addressIn, array('timeout' => 30));
