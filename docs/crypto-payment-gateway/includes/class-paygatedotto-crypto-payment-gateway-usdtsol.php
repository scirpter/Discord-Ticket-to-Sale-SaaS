...
function init_paygatedottocryptogateway_usdtsol_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Usdtsol extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_usdtsol_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdt/convert.php?value=' . $paygatedottocryptogateway_usdtsol_total . '&from=' . strtolower($paygatedottocryptogateway_usdtsol_currency), array('timeout' => 30));
                  ...
                  if ($this->usdtsol_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_usdtsol_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdt/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_usdtsol_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdt/convert.php?value=' . $paygatedottocryptogateway_usdtsol_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdtsol_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdt/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdtsol_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdt/wallet.php?address=' . $this->usdtsol_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_usdtsol_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_usdtsol_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_usdtsol_wallet_decbody && isset($paygatedottocryptogateway_usdtsol_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_usdtsol_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdt/qrcode.php?address=' . $paygatedottocryptogateway_usdtsol_gen_addressIn, array('timeout' => 30));
