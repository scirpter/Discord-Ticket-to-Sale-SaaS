...
function init_paygatedottocryptogateway_usdttrc20_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Usdttrc20 extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_usdttrc20_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/trc20/usdt/convert.php?value=' . $paygatedottocryptogateway_usdttrc20_total . '&from=' . strtolower($paygatedottocryptogateway_usdttrc20_currency), array('timeout' => 30));
                  ...
                  if ($this->usdttrc20_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_usdttrc20_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/trc20/usdt/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_usdttrc20_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/trc20/usdt/convert.php?value=' . $paygatedottocryptogateway_usdttrc20_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdttrc20_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/trc20/usdt/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdttrc20_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/trc20/usdt/wallet.php?address=' . $this->usdttrc20_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_usdttrc20_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_usdttrc20_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_usdttrc20_wallet_decbody && isset($paygatedottocryptogateway_usdttrc20_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_usdttrc20_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/trc20/usdt/qrcode.php?address=' . $paygatedottocryptogateway_usdttrc20_gen_addressIn, array('timeout' => 30));
