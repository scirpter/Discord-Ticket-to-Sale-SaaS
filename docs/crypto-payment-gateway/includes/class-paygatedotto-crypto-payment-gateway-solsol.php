...
function init_paygatedottocryptogateway_solsol_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Solsol extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_solsol_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/sol/convert.php?value=' . $paygatedottocryptogateway_solsol_total . '&from=' . strtolower($paygatedottocryptogateway_solsol_currency), array('timeout' => 30));
                  ...
                  if ($this->solsol_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_solsol_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/sol/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_solsol_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/sol/convert.php?value=' . $paygatedottocryptogateway_solsol_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_solsol_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/sol/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_solsol_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/sol/wallet.php?address=' . $this->solsol_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_solsol_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_solsol_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_solsol_wallet_decbody && isset($paygatedottocryptogateway_solsol_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_solsol_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/sol/qrcode.php?address=' . $paygatedottocryptogateway_solsol_gen_addressIn, array('timeout' => 30));
