...
function init_paygatedottocryptogateway_ltc_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Ltc extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_ltc_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/ltc/convert.php?value=' . $paygatedottocryptogateway_ltc_total . '&from=' . strtolower($paygatedottocryptogateway_ltc_currency), array('timeout' => 30));
                  ...
                  if ($this->ltc_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_ltc_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/ltc/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_ltc_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/ltc/convert.php?value=' . $paygatedottocryptogateway_ltc_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_ltc_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/ltc/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_ltc_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/ltc/wallet.php?address=' . $this->ltc_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_ltc_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_ltc_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_ltc_wallet_decbody && isset($paygatedottocryptogateway_ltc_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_ltc_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/ltc/qrcode.php?address=' . $paygatedottocryptogateway_ltc_gen_addressIn, array('timeout' => 30));
