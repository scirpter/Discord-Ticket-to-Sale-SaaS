...
function init_paygatedottocryptogateway_linkerc20_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Linkerc20 extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_linkerc20_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/link/convert.php?value=' . $paygatedottocryptogateway_linkerc20_total . '&from=' . strtolower($paygatedottocryptogateway_linkerc20_currency), array('timeout' => 30));
                  ...
                  if ($this->linkerc20_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_linkerc20_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/link/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_linkerc20_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/link/convert.php?value=' . $paygatedottocryptogateway_linkerc20_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_linkerc20_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/link/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_linkerc20_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/link/wallet.php?address=' . $this->linkerc20_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_linkerc20_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_linkerc20_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_linkerc20_wallet_decbody && isset($paygatedottocryptogateway_linkerc20_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_linkerc20_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/link/qrcode.php?address=' . $paygatedottocryptogateway_linkerc20_gen_addressIn, array('timeout' => 30));
