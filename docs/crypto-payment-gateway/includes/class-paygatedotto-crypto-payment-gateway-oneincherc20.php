...
function init_paygatedottocryptogateway_oneincherc20_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Oneincherc20 extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_oneincherc20_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/1inch/convert.php?value=' . $paygatedottocryptogateway_oneincherc20_total . '&from=' . strtolower($paygatedottocryptogateway_oneincherc20_currency), array('timeout' => 30));
                  ...
                  if ($this->oneincherc20_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_oneincherc20_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/1inch/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_oneincherc20_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/1inch/convert.php?value=' . $paygatedottocryptogateway_oneincherc20_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_oneincherc20_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/1inch/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_oneincherc20_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/1inch/wallet.php?address=' . $this->oneincherc20_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_oneincherc20_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_oneincherc20_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_oneincherc20_wallet_decbody && isset($paygatedottocryptogateway_oneincherc20_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_oneincherc20_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/erc20/1inch/qrcode.php?address=' . $paygatedottocryptogateway_oneincherc20_gen_addressIn, array('timeout' => 30));
