...
function init_paygatedottocryptogateway_wethpolygon_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Wethpolygon extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_wethpolygon_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/weth/convert.php?value=' . $paygatedottocryptogateway_wethpolygon_total . '&from=' . strtolower($paygatedottocryptogateway_wethpolygon_currency), array('timeout' => 30));
                  ...
                  if ($this->wethpolygon_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_wethpolygon_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/weth/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_wethpolygon_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/weth/convert.php?value=' . $paygatedottocryptogateway_wethpolygon_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_wethpolygon_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/weth/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_wethpolygon_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/weth/wallet.php?address=' . $this->wethpolygon_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_wethpolygon_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_wethpolygon_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_wethpolygon_wallet_decbody && isset($paygatedottocryptogateway_wethpolygon_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_wethpolygon_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/polygon/weth/qrcode.php?address=' . $paygatedottocryptogateway_wethpolygon_gen_addressIn, array('timeout' => 30));
