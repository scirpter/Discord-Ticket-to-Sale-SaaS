...
function init_paygatedottocryptogateway_usdcsol_gateway()
{
      ...
      class PayGateDotTo_Crypto_Payment_Gateway_Usdcsol extends WC_Payment_Gateway
      {
            ...
            public function process_payment($order_id)
            {
                  ...
                  $paygatedottocryptogateway_usdcsol_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdc/convert.php?value=' . $paygatedottocryptogateway_usdcsol_total . '&from=' . strtolower($paygatedottocryptogateway_usdcsol_currency), array('timeout' => 30));
                  ...
                  if ($this->usdcsol_blockchain_fees === 'yes') {
                        ...
                        $paygatedottocryptogateway_usdcsol_feesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdc/fees.php', array('timeout' => 30));
                        ...
                        $paygatedottocryptogateway_usdcsol_revfeesest_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdc/convert.php?value=' . $paygatedottocryptogateway_usdcsol_feesest_reference_total . '&from=usd', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdcsol_response_minimum = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdc/info.php', array('timeout' => 30));
                  ...
                  $paygatedottocryptogateway_usdcsol_gen_wallet = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdc/wallet.php?address=' . $this->usdcsol_wallet_address . '&callback=' . urlencode($paygatedottocryptogateway_usdcsol_callback), array('timeout' => 30));
                  ...
                  if (is_wp_error($paygatedottocryptogateway_usdcsol_gen_wallet)) {
                        ...
                        if ($paygatedottocryptogateway_usdcsol_wallet_decbody && isset($paygatedottocryptogateway_usdcsol_wallet_decbody['address_in'])) {
                              ...
                              $paygatedottocryptogateway_usdcsol_genqrcode_response = wp_remote_get('https://api.voodoo-pay.uk/crypto/sol/usdc/qrcode.php?address=' . $paygatedottocryptogateway_usdcsol_gen_addressIn, array('timeout' => 30));
