...
- Ranks evidence by meaningful query terms, page titles, URLs, and source readiness, then diversifies website, Custom Q&A, and Discord channel results before building the grounded answer prompt.
